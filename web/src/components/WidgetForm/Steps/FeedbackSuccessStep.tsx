...
const FeedbackSuccessSteps: React.FC<Props> = ({
  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center py-10 w-[304px]">
        ...
        <span className="text-xl mt-2 text-tx-800">
          Agradecemos o feedback!
        </span>
        <button
          onClick={onFeedbackRestartRequested}
          type="button"
          className="py-2 px-6 mt-6 bg-tx-800  rounded-md border-transparent text-sm leading-6 hover:bg-tx-700 transition-colors focus:ring-2 focus:ring-offset-2 focus:ring-offset-surface-300 focus:ring-brand-500"
        >
          Quero enviar outro
        </button>
      </div>
